    ...
    <div class="bg-white p-8 rounded shadow-lg w-full max-w-md">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="text-center mt-4">
          <button
            type="submit"
            class="w-full bg-primary text-white py-2 px-4 rounded hover:bg-primary focus:outline-none focus:ring focus:border-blue-300 transition duration-200 ease-in-out"
            :disabled="isLoading"
          >
            <span
              v-if="isLoading"
        ...
        <div class="mt-4 text-center underline">
          <router-link to="/signup" class="text-primary hover:text-blue-800"

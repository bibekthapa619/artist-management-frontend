    ...
    <div class="bg-white p-8 rounded shadow-lg w-full max-w-md">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="text-center">
          <button
            type="submit"
            class="w-full bg-primary text-white py-2 px-4 rounded hover:bg-primary-hover focus:outline-none focus:ring focus:border-blue-300 transition duration-200 ease-in-out"
            :disabled="isLoading"
          >
            <span
              v-if="isLoading"
